...
function appendNewCard(parentElement) {
  ...
  //parentElement = document.getElementById("card-container");
...
function shuffleCardImageClasses() {
  ...
  let shuffle = _.shuffle(cardClasses);
...
function createCards(parentElement, shuffledImageClasses) {
  ...
  for (let i = 0; i < 12; i++) {
    let appendResult = appendNewCard(parentElement);
    appendResult.classList.add(shuffledImageClasses[i]);
    let imgObj = {
      index: i,
      element: appendResult,
